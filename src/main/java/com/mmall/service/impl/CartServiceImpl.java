...
public class CartServiceImpl implements ICartService {
    ...
    public ServerResponse selectOrUnselect(Integer userId, Integer checked,Integer productId) {
        cartMapper.checkeOrUncheckedProduct(userId, checked,productId);
        return this.list(userId);
    }
    ...
    public ServerResponse getCartProductCount(Integer userId){
        ...
        int reusultCount = cartMapper.selectCartProductCount(userId);
        return ServerResponse.createBySuccess(reusultCount);
    }
}
